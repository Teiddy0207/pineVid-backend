...
func (m *MockVideo) GetByID(ctx context.Context, id, userID string) (response.VideoResponse, error) {
	m.ctrl.T.Helper()
...
func (mr *MockVideoMockRecorder) GetByID(ctx, id, userID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetByID", reflect.TypeOf((*MockVideo)(nil).GetByID), ctx, id, userID)
}

// GetReelsFeed mocks base method.
func (m *MockVideo) GetReelsFeed(ctx context.Context, userID, window string, page, limit int) (response.PageResponse[response.VideoResponse], error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetReelsFeed", ctx, userID, window, page, limit)
	ret0, _ := ret[0].(response.PageResponse[response.VideoResponse])
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetReelsFeed indicates an expected call of GetReelsFeed.
func (mr *MockVideoMockRecorder) GetReelsFeed(ctx, userID, window, page, limit any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetReelsFeed", reflect.TypeOf((*MockVideo)(nil).GetReelsFeed), ctx, userID, window, page, limit)
}

// GetTrending mocks base method.
func (m *MockVideo) GetTrending(ctx context.Context, window, userID string, page, limit int) (response.PageResponse[response.VideoResponse], error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetTrending", ctx, window, userID, page, limit)
	ret0, _ := ret[0].(response.PageResponse[response.VideoResponse])
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockVideoMockRecorder) GetTrending(ctx, window, userID, page, limit any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetTrending", reflect.TypeOf((*MockVideo)(nil).GetTrending), ctx, window, userID, page, limit)
}
...
func (m *MockVideo) ListStudioVideos(ctx context.Context, userID, query string, page, limit int) (response.PageResponse[response.VideoResponse], error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListStudioVideos", ctx, userID, query, page, limit)
	ret0, _ := ret[0].(response.PageResponse[response.VideoResponse])
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockVideoMockRecorder) ListStudioVideos(ctx, userID, query, page, limit any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListStudioVideos", reflect.TypeOf((*MockVideo)(nil).ListStudioVideos), ctx, userID, query, page, limit)
}
...
// RetryTranscode mocks base method.
func (m *MockVideo) RetryTranscode(ctx context.Context, userID, videoID string) (response.VideoResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "RetryTranscode", ctx, userID, videoID)
	ret0, _ := ret[0].(response.VideoResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// RetryTranscode indicates an expected call of RetryTranscode.
func (mr *MockVideoMockRecorder) RetryTranscode(ctx, userID, videoID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "RetryTranscode", reflect.TypeOf((*MockVideo)(nil).RetryTranscode), ctx, userID, videoID)
}
...
func (m *MockPost) CreatePost(ctx context.Context, userID, userName, userAvatar string, req request.CreatePostRequest) (response.PostResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreatePost", ctx, userID, userName, userAvatar, req)
	ret0, _ := ret[0].(response.PostResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// CreatePost indicates an expected call of CreatePost.
func (mr *MockPostMockRecorder) CreatePost(ctx, userID, userName, userAvatar, req any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreatePost", reflect.TypeOf((*MockPost)(nil).CreatePost), ctx, userID, userName, userAvatar, req)
}

// DeletePost mocks base method.
func (m *MockPost) DeletePost(ctx context.Context, userID, postID string) error {
	m.ctrl.T.Helper()
...
func (mr *MockPostMockRecorder) DeletePost(ctx, userID, postID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeletePost", reflect.TypeOf((*MockPost)(nil).DeletePost), ctx, userID, postID)
}

// ListPostsByUser mocks base method.
func (m *MockPost) ListPostsByUser(ctx context.Context, userID, viewerID string, page, limit int) (response.PageResponse[response.PostResponse], error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListPostsByUser", ctx, userID, viewerID, page, limit)
	ret0, _ := ret[0].(response.PageResponse[response.PostResponse])
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ListPostsByUser indicates an expected call of ListPostsByUser.
func (mr *MockPostMockRecorder) ListPostsByUser(ctx, userID, viewerID, page, limit any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListPostsByUser", reflect.TypeOf((*MockPost)(nil).ListPostsByUser), ctx, userID, viewerID, page, limit)
}

// TogglePostLike mocks base method.
func (m *MockPost) TogglePostLike(ctx context.Context, postID, userID string) (response.PostLikeResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "TogglePostLike", ctx, postID, userID)
	ret0, _ := ret[0].(response.PostLikeResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// TogglePostLike indicates an expected call of TogglePostLike.
func (mr *MockPostMockRecorder) TogglePostLike(ctx, postID, userID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "TogglePostLike", reflect.TypeOf((*MockPost)(nil).TogglePostLike), ctx, postID, userID)
}
...
// BroadcastHeart mocks base method.
func (m *MockLivestream) BroadcastHeart(streamID string, totalHearts int64) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "BroadcastHeart", streamID, totalHearts)
}

// BroadcastHeart indicates an expected call of BroadcastHeart.
func (mr *MockLivestreamMockRecorder) BroadcastHeart(streamID, totalHearts any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "BroadcastHeart", reflect.TypeOf((*MockLivestream)(nil).BroadcastHeart), streamID, totalHearts)
}
...
// ReconcileLiveStreams mocks base method.
func (m *MockLivestream) ReconcileLiveStreams(ctx context.Context) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ReconcileLiveStreams", ctx)
	ret0, _ := ret[0].(error)
	return ret0
}

// ReconcileLiveStreams indicates an expected call of ReconcileLiveStreams.
func (mr *MockLivestreamMockRecorder) ReconcileLiveStreams(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ReconcileLiveStreams", reflect.TypeOf((*MockLivestream)(nil).ReconcileLiveStreams), ctx)
}
...
func (m *MockComment) ListReplies(ctx context.Context, parentID, userID string, page, limit int) (response.PageResponse[response.CommentResponse], error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListReplies", ctx, parentID, userID, page, limit)
...
func (mr *MockCommentMockRecorder) ListReplies(ctx, parentID, userID, page, limit any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListReplies", reflect.TypeOf((*MockComment)(nil).ListReplies), ctx, parentID, userID, page, limit)
}

// ListVideoComments mocks base method.
func (m *MockComment) ListVideoComments(ctx context.Context, videoID, userID string, page, limit int) (response.CommentPageResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListVideoComments", ctx, videoID, userID, page, limit)
	ret0, _ := ret[0].(response.CommentPageResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ListVideoComments indicates an expected call of ListVideoComments.
func (mr *MockCommentMockRecorder) ListVideoComments(ctx, videoID, userID, page, limit any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListVideoComments", reflect.TypeOf((*MockComment)(nil).ListVideoComments), ctx, videoID, userID, page, limit)
}

// ToggleLikeComment mocks base method.
func (m *MockComment) ToggleLikeComment(ctx context.Context, commentID, userID string) (response.CommentLikeResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ToggleLikeComment", ctx, commentID, userID)
	ret0, _ := ret[0].(response.CommentLikeResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ToggleLikeComment indicates an expected call of ToggleLikeComment.
func (mr *MockCommentMockRecorder) ToggleLikeComment(ctx, commentID, userID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ToggleLikeComment", reflect.TypeOf((*MockComment)(nil).ToggleLikeComment), ctx, commentID, userID)
}
...
// MockSavedVideo is a mock of SavedVideo interface.
type MockSavedVideo struct {
	ctrl     *gomock.Controller
	recorder *MockSavedVideoMockRecorder
	isgomock struct{}
}

// MockSavedVideoMockRecorder is the mock recorder for MockSavedVideo.
type MockSavedVideoMockRecorder struct {
	mock *MockSavedVideo
}

// NewMockSavedVideo creates a new mock instance.
func NewMockSavedVideo(ctrl *gomock.Controller) *MockSavedVideo {
	mock := &MockSavedVideo{ctrl: ctrl}
	mock.recorder = &MockSavedVideoMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockSavedVideo) EXPECT() *MockSavedVideoMockRecorder {
	return m.recorder
}

// ListSavedVideos mocks base method.
func (m *MockSavedVideo) ListSavedVideos(ctx context.Context, userID string, page, limit int) (response.PageResponse[response.VideoResponse], error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListSavedVideos", ctx, userID, page, limit)
	ret0, _ := ret[0].(response.PageResponse[response.VideoResponse])
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockSavedVideoMockRecorder) ListSavedVideos(ctx, userID, page, limit any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListSavedVideos", reflect.TypeOf((*MockSavedVideo)(nil).ListSavedVideos), ctx, userID, page, limit)
}

// ToggleSaveVideo mocks base method.
func (m *MockSavedVideo) ToggleSaveVideo(ctx context.Context, userID, videoID string) (response.SaveVideoResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ToggleSaveVideo", ctx, userID, videoID)
	ret0, _ := ret[0].(response.SaveVideoResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ToggleSaveVideo indicates an expected call of ToggleSaveVideo.
func (mr *MockSavedVideoMockRecorder) ToggleSaveVideo(ctx, userID, videoID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ToggleSaveVideo", reflect.TypeOf((*MockSavedVideo)(nil).ToggleSaveVideo), ctx, userID, videoID)
}

// MockUserPreference is a mock of UserPreference interface.
type MockUserPreference struct {
	ctrl     *gomock.Controller
	recorder *MockUserPreferenceMockRecorder
	isgomock struct{}
}

// MockUserPreferenceMockRecorder is the mock recorder for MockUserPreference.
type MockUserPreferenceMockRecorder struct {
	mock *MockUserPreference
}

// NewMockUserPreference creates a new mock instance.
func NewMockUserPreference(ctrl *gomock.Controller) *MockUserPreference {
	mock := &MockUserPreference{ctrl: ctrl}
	mock.recorder = &MockUserPreferenceMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockUserPreference) EXPECT() *MockUserPreferenceMockRecorder {
	return m.recorder
}

// GetPreferredCategories mocks base method.
func (m *MockUserPreference) GetPreferredCategories(ctx context.Context, userID string) ([]string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetPreferredCategories", ctx, userID)
	ret0, _ := ret[0].([]string)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetPreferredCategories indicates an expected call of GetPreferredCategories.
func (mr *MockUserPreferenceMockRecorder) GetPreferredCategories(ctx, userID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetPreferredCategories", reflect.TypeOf((*MockUserPreference)(nil).GetPreferredCategories), ctx, userID)
}

// SetPreferredCategories mocks base method.
func (m *MockUserPreference) SetPreferredCategories(ctx context.Context, userID string, categories []string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SetPreferredCategories", ctx, userID, categories)
	ret0, _ := ret[0].(error)
	return ret0
}

// SetPreferredCategories indicates an expected call of SetPreferredCategories.
func (mr *MockUserPreferenceMockRecorder) SetPreferredCategories(ctx, userID, categories any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SetPreferredCategories", reflect.TypeOf((*MockUserPreference)(nil).SetPreferredCategories), ctx, userID, categories)
}
...
func (m *MockNotification) MarkAllAsRead(ctx context.Context, userID string) error {
	m.ctrl.T.Helper()
...
func (mr *MockNotificationMockRecorder) MarkAllAsRead(ctx, userID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "MarkAllAsRead", reflect.TypeOf((*MockNotification)(nil).MarkAllAsRead), ctx, userID)
}
